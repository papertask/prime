                ...
                <fieldset class="form-group">
                    <select class="selectpicker form-control category">
                        ...
                        foreach ( $categories as $category ) {
                            ...
                            ?>
                            <option <?php echo ($category->term_id === $cat_id) ? 'selected' : ''; ?> data-url="<?php echo esc_attr( get_category_link( $category->term_id ) ); ?>" value="<?php echo $category->term_id; ?>"><?php echo $category->name; ?></option>
                        <?php } ?>
                    </select>
                </fieldset>
            </div>
