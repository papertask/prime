<div class="clients-grid" id="<?php echo $panel_id; ?>">
    ...
    <ul class="cat-list-bg-style align-center categories sorting-menu">
        ...
        <li class="cat-list__item <?php echo (!$cat_id) ? 'active' : ''; ?>"><a href="0" data-url="<?php echo esc_url( $page_for_posts_url ); ?>" class=""><?php _e( 'All categories', 'crum-ext-ajax-blog' ) ?></a></li>
