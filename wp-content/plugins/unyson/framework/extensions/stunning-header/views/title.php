...
if ( !empty( $title_text ) ) {
    ...
    ?>
    <h1 class="stunning-header-title"><?php esc_html_e( 'Latest posts', 'crumina' ); ?></h1>
<?php } elseif ( is_search() ) { ?>
    <span class="stunning-header-title h1 page-title">
        <?php printf( esc_html__( 'Search Results for: %s', 'crumina' ), '<h1 class="stunning-header-title d-inline">"' . get_search_query() . '"</h1>' ); ?>
    </span>
<?php } elseif ( is_404() ) { ?>
    <h1 class="stunning-header-title"><?php esc_html_e( '404 Error Page', 'crumina' ); ?></h1>
    <?php
    ...
    <?php } elseif ( is_product() ) { ?>
        <h2 class="stunning-header-title h1"><?php esc_html_e( 'Product Details', 'crumina' ); ?></h2>
        <?php
    ...
    ?>
    <h1 class="stunning-header-title"><?php esc_html_e( 'Events', 'crumina' ); ?></h1>
    <?php
} elseif ( is_archive() ) {
    ?>
