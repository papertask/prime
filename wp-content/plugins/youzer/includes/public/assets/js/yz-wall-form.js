	...
	$( document ).ready( function() {
		...
		$( document ).on('change', 'input:radio[name="post_type"]', function() {
			...
			if( inputs_lenght > 1 ) {
				...
				if (  $( '.yz-wall-custom-form[data-post-type!="' + post_type + '"]' ).length == 0 ) {
	            	$( '.yz-wall-custom-form[data-post-type="' + post_type + '"]' ).fadeIn();
				} else {
		            $( '.yz-wall-custom-form[data-post-type!="' + post_type + '"]' ).fadeOut( 1, function() {
		            	$( '.yz-wall-custom-form[data-post-type="' + post_type + '"]' ).fadeIn();
		            });
				}
