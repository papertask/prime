 ...
 * @since 4.0
 */
if ( ! class_exists( 'DTWPB_Thankyou_Tpl' ) ) {
	
	require_once vc_path_dir( 'EDITORS_DIR', 'class-vc-backend-editor.php' );
	
	class DTWPB_Thankyou_Tpl extends Vc_Backend_Editor{
		protected static $post_type = 'dtwpb_thankyou';
		...
		public static function createPostType() {
			...
			register_post_type( self::$post_type, array(
						'labels' => array(
							'name' => esc_html__( 'Thank you Templates', 'dt_woocommerce_page_builder' ), 
							'singular_name' => esc_html__( 'Thank you Template', 'dt_woocommerce_page_builder' ), 
							'menu_name' => _x( 'Thank you Templates', 'Admin menu name', 'dt_woocommerce_page_builder' ), 
