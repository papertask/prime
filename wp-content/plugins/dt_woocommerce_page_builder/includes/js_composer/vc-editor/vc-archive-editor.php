 ...
 * @since 4.0
 */
if ( ! class_exists( 'dtwpb_posttype_archive_tpl' ) ) {
	
	require_once vc_path_dir( 'EDITORS_DIR', 'class-vc-backend-editor.php' );
	
	class dtwpb_posttype_archive_tpl extends Vc_Backend_Editor{
		protected static $post_type = 'dtwpb_cat_tpl';
		...
		public static function createPostType() {
			...
			register_post_type( self::$post_type, array(
						'labels' => array(
							'name' => esc_html__( 'Product Archive Templates', 'dt_woocommerce_page_builder' ), 
							'singular_name' => esc_html__( 'Product Archive Template', 'dt_woocommerce_page_builder' ), 
							'menu_name' => _x( 'Product Archive Templates', 'Admin menu name', 'dt_woocommerce_page_builder' ), 
							'add_new' => esc_html__( 'Add New Product Archive Templates', 'dt_woocommerce_page_builder' ), 
							'add_new_item' => esc_html__( 'Add New', 'dt_woocommerce_page_builder' ), 
							'edit' => esc_html__( 'Edit', 'dt_woocommerce_page_builder' ), 
							'edit_item' => esc_html__( 'Edit Category Template', 'dt_woocommerce_page_builder' ), 
