 ...
 */
$el_class             = $full_height          = $animate_bg           = $animate_direction    = $animate_overlay      = $half_bg              = $half_bg_pos          = $parallax_speed_bg    = $parallax_speed_video = $full_width           = $equal_height         = $flex_row             = $columns_placement    = $content_placement    = $parallax             = $parallax_image       = $css                  = $el_id                = $video_bg             = $video_bg_url         = $video_bg_parallax    = $css_animation        = '';
$disable_element      = '';
