...
wp_enqueue_script( 'count-to', get_template_directory_uri() . '/js/plugins/jquery.countTo.js', array( 'jquery' ), null, true );
...
wp_register_script( 'sharer', get_template_directory_uri() . '/js/plugins/sharer.min.js', array(), '0.3.2', true );
...
wp_enqueue_script( 'olympus-main', get_template_directory_uri() . '/js/theme-main.js', array( 'reframe', 'smooth-scroll', 'material-forms', 'scroll-to-fixed', 'bootstrap-select', 'ico-moon', 'jquery-match-height', 'olympus-mega-menu', 'jquery-mousewheel', 'count-to', 'waypoints', 'password-strength-meter' ), $theme_version, true );
