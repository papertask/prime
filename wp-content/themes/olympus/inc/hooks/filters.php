...
add_filter( 'nav_menu_link_attributes', '_filter_olympus_replace_ampersand', 10, 4 );
...
add_filter( 'wp_nav_menu_objects', '_filter_olympus_update_login_url', 99, 2 );
...
function _filter_olympus_update_login_url( $sorted_menu_items, $args ) {
	...
	foreach ( $sorted_menu_items as $item ) {
		if ( preg_match( '/\/wp\-login\.php/i', $item->url ) ) {
