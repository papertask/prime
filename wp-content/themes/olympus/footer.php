...
$description_logo_pos = olympus_akg( 'yes/footer-logo/yes/logo-alignment', $description_options, false );
            ...
            <div class="<?php echo esc_attr( $desc_columns_class ) ?>">
                <div class="w-about widget" itemscope itemtype="http://schema.org/Organization">
                    ...
                    if ( 'yes' === $show_footer_logo ) {
                        ...
                        olympus_logo( $description_logo, $description_logo_pos );
                        echo '</div>';
                    }
        ...
        <?php if ( is_active_sidebar( 'sidebar-footer' ) ) { ?>
            <div class="<?php echo esc_attr( $sidebar_columns ); ?>">
                <div class="row">
                    ...
                    $footer_sibebar_columns = 'col-lg-' . $footer_sibebar_columns . ' col-md-6 col-sm-12 col-xs-12';
